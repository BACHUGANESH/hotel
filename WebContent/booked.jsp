  ...
  <br>
   		<table cellspacing="5" border="2" width="80%">
			 ...
			 <%while(rs.next())
			{
				%>
			 <tr>			
			 <td align="left"><font color="#00008B"><%=name%></font></td>
